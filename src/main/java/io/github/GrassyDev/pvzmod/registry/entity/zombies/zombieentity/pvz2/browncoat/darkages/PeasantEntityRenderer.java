...
public class PeasantEntityRenderer extends GeoEntityRenderer<PeasantEntity> {
	...
	@Override
	public Color getRenderColor(PeasantEntity animatable, float partialTick, int packedLight) {
		Color color = PeasantEntityRenderer.super.getRenderColor(animatable, partialTick, packedLight);
