...
public class ShootingFlamingpeaEntityRenderer extends GeoEntityRenderer<ShootingFlamingPeaEntity> {
	@Override
	public void preRender(MatrixStack poseStack, ShootingFlamingPeaEntity animatable, BakedGeoModel model, VertexConsumerProvider bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue,
						  float alpha) {
