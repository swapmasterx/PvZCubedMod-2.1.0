...
public class Bark extends StatusEffect {
    public Bark() {
		...
		addAttributeModifier(EntityAttributes.GENERIC_MOVEMENT_SPEED, Identifier.of("minecraft", "movement_speed"), -0.115375, EntityAttributeModifier.Operation.ADD_MULTIPLIED_TOTAL);
    }
