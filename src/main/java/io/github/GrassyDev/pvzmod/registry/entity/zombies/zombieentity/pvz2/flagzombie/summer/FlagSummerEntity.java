...
//				//				zombieVillagerEntity.setOfferData(villagerEntity.getOffers().toNbt());
	...
	protected abstract class CastSpellGoal extends Goal {
		...
		public boolean canStart() {
			...
			if (livingEntity != null && livingEntity.isAlive() && !FlagSummerEntity.this.hasStatusEffect(StatusHolder.FROZEN_HOLDER) && !FlagSummerEntity.this.hasStatusEffect(StatusHolder.STUN_HOLDER)) {
		...
		public boolean shouldContinue() {
			LivingEntity livingEntity = FlagSummerEntity.this.getTarget();
			return livingEntity != null && livingEntity.isAlive() && this.spellCooldown > 0 && !FlagSummerEntity.this.hasStatusEffect(StatusHolder.FROZEN_HOLDER) && !FlagSummerEntity.this.hasStatusEffect(StatusHolder.STUN_HOLDER) && FlagSummerEntity.this.getTypeCount() < 4;
		}
