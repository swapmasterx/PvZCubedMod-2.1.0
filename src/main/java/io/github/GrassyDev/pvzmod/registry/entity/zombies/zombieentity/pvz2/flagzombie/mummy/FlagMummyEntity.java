...
public class FlagMummyEntity extends SummonerEntity implements GeoEntity {
...
//	}
	...
	protected abstract class CastSpellGoal extends Goal {
		...
		public boolean canStart() {
			...
			if (livingEntity != null && livingEntity.isAlive() && !FlagMummyEntity.this.hasStatusEffect(StatusHolder.FROZEN_HOLDER) && !FlagMummyEntity.this.hasStatusEffect(StatusHolder.STUN_HOLDER)) {
		...
		public boolean shouldContinue() {
			LivingEntity livingEntity = FlagMummyEntity.this.getTarget();
			return livingEntity != null && livingEntity.isAlive() && this.spellCooldown > 0 && !FlagMummyEntity.this.hasStatusEffect(StatusHolder.FROZEN_HOLDER) && !FlagMummyEntity.this.hasStatusEffect(StatusHolder.STUN_HOLDER) && FlagMummyEntity.this.getTypeCount() < 4;
		}
