...
public class ShootingButterEntity extends PvZProjectileEntity implements GeoEntity {
    ...
    public ShootingButterEntity(EntityType<? extends ThrownItemEntity> entityType, World world) {
        super(entityType, world);
		this.setNoGravity(false);
    }

    public ShootingButterEntity(World world, LivingEntity owner) {
	...
	public void hitEntities() {
		...
		while (true) {
			...
			if (!getWorld().isClient && entity instanceof Monster monster &&
				...
				((LivingEntity) entity).addStatusEffect((new StatusEffectInstance(StatusHolder.STUN_HOLDER, 160, 1)));
