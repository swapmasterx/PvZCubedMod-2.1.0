...
public class MetalVehicleEntityRenderer extends GeoEntityRenderer<MetalVehicleEntity> {
	...
	@Override
	public Color getRenderColor(MetalVehicleEntity animatable, float partialTick, int packedLight) {
		Color color = MetalVehicleEntityRenderer.super.getRenderColor(animatable, partialTick, packedLight);
