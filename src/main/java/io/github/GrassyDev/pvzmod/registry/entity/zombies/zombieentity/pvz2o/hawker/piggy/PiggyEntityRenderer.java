...
public class PiggyEntityRenderer extends GeoEntityRenderer<PiggyEntity> {
	...
	@Override
	public Color getRenderColor(PiggyEntity animatable, float partialTick, int packedLight) {
		Color color = PiggyEntityRenderer.super.getRenderColor(animatable, partialTick, packedLight);
