...
public class ShootingIcebergEntity extends PvZProjectileEntity implements GeoAnimatable {
		...
		while (true) {
			...
			if (!getWorld().isClient && entity instanceof Monster monster &&
					...
					if (damage > ((LivingEntity) entity).getHealth() &&
						...
						entity.damage(getDamageSources().mobProjectile(this, this.target), damage);
						generalPvZombieEntity.damage(getDamageSources().mobProjectile(this, this.target), damage2);
					} else {
						entity.damage(getDamageSources().mobProjectile(this, this.target), damage);
					}
