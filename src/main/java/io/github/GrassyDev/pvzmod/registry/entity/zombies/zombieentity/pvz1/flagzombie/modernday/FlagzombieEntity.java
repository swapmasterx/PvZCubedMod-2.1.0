...
//	}
	...
	protected abstract class CastSpellGoal extends Goal {
		...
		public boolean canStart() {
			...
			if (livingEntity != null && livingEntity.isAlive() && !FlagzombieEntity.this.hasStatusEffect(StatusHolder.FROZEN_HOLDER) && !FlagzombieEntity.this.hasStatusEffect(PvZCubed.STUN)) {
		...
		public boolean shouldContinue() {
			LivingEntity livingEntity = FlagzombieEntity.this.getTarget();
			return livingEntity != null && livingEntity.isAlive() && this.spellCooldown > 0 && !FlagzombieEntity.this.hasStatusEffect(StatusHolder.FROZEN_HOLDER) && !FlagzombieEntity.this.hasStatusEffect(PvZCubed.STUN) && FlagzombieEntity.this.getTypeCount() < 4;
		}
