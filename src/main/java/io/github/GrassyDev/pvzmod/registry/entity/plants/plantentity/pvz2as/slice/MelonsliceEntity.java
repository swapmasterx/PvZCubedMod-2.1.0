...
public class MelonsliceEntity extends PlantEntity implements GeoEntity, RangedAttackMob {
			...
			if ((!this.plantEntity.canSee(livingEntity)) &&
				...
				if (this.beamTicks >= 0) {
					...
					if (!this.plantEntity.isInsideWaterOrBubbleColumn()) {
						ShootingMelonSliceEntity proj = new ShootingMelonSliceEntity(PvZEntity.MELONSLICE, this.plantEntity.getWorld());
