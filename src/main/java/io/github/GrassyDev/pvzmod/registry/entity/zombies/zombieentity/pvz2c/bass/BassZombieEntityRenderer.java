...
public class BassZombieEntityRenderer extends GeoEntityRenderer<BassZombieEntity> {
	...
	@Override
	public void preRender(MatrixStack poseStack, BassZombieEntity animatable, BakedGeoModel model, VertexConsumerProvider bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue,
						  float alpha) {
