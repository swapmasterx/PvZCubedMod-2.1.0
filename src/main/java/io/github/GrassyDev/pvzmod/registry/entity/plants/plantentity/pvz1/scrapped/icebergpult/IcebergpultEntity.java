...
public class IcebergpultEntity extends PlantEntity implements GeoAnimatable, RangedAttackMob {
			...
			if ((!this.plantEntity.canSee(livingEntity)) &&
				...
				if (this.beamTicks >= 0) {
					if (!this.plantEntity.isInsideWaterOrBubbleColumn()) {
						ShootingIcebergEntity proj = new ShootingIcebergEntity(PvZEntity.ICEBERG, this.plantEntity.getWorld());
