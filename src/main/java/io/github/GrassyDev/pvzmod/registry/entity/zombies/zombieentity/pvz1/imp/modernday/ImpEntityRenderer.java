...
public class ImpEntityRenderer extends GeoEntityRenderer<ImpEntity> {
	...
	@Override
	public Color getRenderColor(ImpEntity animatable, float partialTick, int packedLight) {
		Color color = ImpEntityRenderer.super.getRenderColor(animatable, partialTick, packedLight);
