...
public class PeaNutProjEntity extends PvZProjectileEntity implements GeoEntity {
	...
	private <P extends GeoAnimatable> PlayState predicate(AnimationState<P> event) {
		event.getController().setAnimation(RawAnimation.begin().thenLoop("peanut.projectile"));
    ...
    public PeaNutProjEntity(World world, double x, double y, double z, float yaw, float pitch, int interpolation, int id, UUID uuid) {
