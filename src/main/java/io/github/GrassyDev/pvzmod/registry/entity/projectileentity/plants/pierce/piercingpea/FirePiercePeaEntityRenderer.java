...
public class FirePiercePeaEntityRenderer extends GeoEntityRenderer<FirePiercePeaEntity> {
	@Override
	public void preRender(MatrixStack poseStack, FirePiercePeaEntity animatable, BakedGeoModel model, VertexConsumerProvider bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue,
						  float alpha) {
