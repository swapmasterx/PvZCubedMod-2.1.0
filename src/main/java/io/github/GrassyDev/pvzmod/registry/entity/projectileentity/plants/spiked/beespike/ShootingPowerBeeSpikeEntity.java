...
public class ShootingPowerBeeSpikeEntity extends PvZProjectileEntity implements GeoEntity {
    ...
    public static final Identifier PacketID = Identifier.of(PvZEntity.ModID, "powerbeespike");
...
//				}
		...
		if (!this.getWorld().isClient && this.age >= 58 || this.damageCounter >= 4) {
			this.remove(RemovalReason.DISCARDED);
		}
	}
	...
	public void hitEntities() {
		...
		while (true) {
			...
			if (!getWorld().isClient && entity instanceof Monster monster &&
				...
				((LivingEntity) entity).addStatusEffect((new StatusEffectInstance(StatusHolder.POISON_HOLDER, 60, 5)));
				entityStore.add((LivingEntity) entity);
			}
		}
	}
