...
public class ActionheroEntityRenderer extends GeoEntityRenderer<ActionheroEntity> {
	...
	@Override
	public Color getRenderColor(ActionheroEntity animatable, float partialTick, int packedLight) {
		Color color = ActionheroEntityRenderer.super.getRenderColor(animatable, partialTick, packedLight);
