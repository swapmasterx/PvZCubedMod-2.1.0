...
public class ActionheroEntityRenderer extends GeoEntityRenderer<ActionheroEntity> {
	...
	@Override
	public void preRender(MatrixStack poseStack, ActionheroEntity animatable, BakedGeoModel model, VertexConsumerProvider bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue,
						  float alpha) {
