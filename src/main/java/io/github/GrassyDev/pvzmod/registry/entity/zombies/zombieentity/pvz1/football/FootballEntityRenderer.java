...
public class FootballEntityRenderer extends GeoEntityRenderer<FootballEntity> {
	...
	@Override
	public void preRender(MatrixStack poseStack, FootballEntity animatable, BakedGeoModel model, VertexConsumerProvider bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue,
						  float alpha) {
