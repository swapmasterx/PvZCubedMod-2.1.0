...
public class RockObstacleEntityRenderer extends GeoEntityRenderer<RockObstacleEntity> {
	...
	@Override
	public void preRender(MatrixStack poseStack, RockObstacleEntity animatable, BakedGeoModel model, VertexConsumerProvider bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue,
						  float alpha) {
