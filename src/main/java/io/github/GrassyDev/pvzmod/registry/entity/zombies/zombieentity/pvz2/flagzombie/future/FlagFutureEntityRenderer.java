...
public class FlagFutureEntityRenderer extends GeoEntityRenderer<FlagFutureEntity> {
	...
	@Override
	public Color getRenderColor(FlagFutureEntity animatable, float partialTick, int packedLight) {
		Color color = FlagFutureEntityRenderer.super.getRenderColor(animatable, partialTick, packedLight);
