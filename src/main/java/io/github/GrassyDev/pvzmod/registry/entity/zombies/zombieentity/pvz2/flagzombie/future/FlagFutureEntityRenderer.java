...
public class FlagFutureEntityRenderer extends GeoEntityRenderer<FlagFutureEntity> {
	...
	@Override
	public void preRender(MatrixStack poseStack, FlagFutureEntity animatable, BakedGeoModel model, VertexConsumerProvider bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue,
						  float alpha) {
