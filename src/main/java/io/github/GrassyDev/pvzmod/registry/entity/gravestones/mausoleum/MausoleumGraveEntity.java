...
public class MausoleumGraveEntity extends GraveEntity implements GeoEntity {
	...
	protected abstract class CastSpellGoal extends Goal {
		...
		public void start() {
			...
			if (soundEvent != null) {
				MausoleumGraveEntity.this.playSound(soundEvent, 0.9F, 1.0F);
			}
		...
		public void tick() {
			...
			if (this.spellCooldown == 0) {
				this.castSpell();
				MausoleumGraveEntity.this.addStatusEffect((new StatusEffectInstance(StatusEffects.GLOWING, 100, 1)));
				MausoleumGraveEntity.this.playSound(MausoleumGraveEntity.this.getCastSpellSound(), 0.9F, 1.0F);
			}
