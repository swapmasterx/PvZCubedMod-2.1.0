...
public class FlagMummyEntityRenderer extends GeoEntityRenderer<FlagMummyEntity> {
	...
	@Override
	public Color getRenderColor(FlagMummyEntity animatable, float partialTick, int packedLight) {
		Color color = FlagMummyEntityRenderer.super.getRenderColor(animatable, partialTick, packedLight);
