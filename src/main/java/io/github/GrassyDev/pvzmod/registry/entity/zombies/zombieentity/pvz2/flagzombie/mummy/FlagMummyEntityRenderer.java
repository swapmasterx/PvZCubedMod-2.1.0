...
public class FlagMummyEntityRenderer extends GeoEntityRenderer<FlagMummyEntity> {
	...
	@Override
	public void preRender(MatrixStack poseStack, FlagMummyEntity animatable, BakedGeoModel model, VertexConsumerProvider bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue,
						  float alpha) {
