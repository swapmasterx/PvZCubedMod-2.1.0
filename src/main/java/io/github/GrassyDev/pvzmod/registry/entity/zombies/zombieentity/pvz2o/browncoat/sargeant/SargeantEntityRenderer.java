...
public class SargeantEntityRenderer extends GeoEntityRenderer<SargeantEntity> {
	...
	@Override
	public Color getRenderColor(SargeantEntity animatable, float partialTick, int packedLight) {
		Color color = SargeantEntityRenderer.super.getRenderColor(animatable, partialTick, packedLight);
