...
public class PharaohEntityRenderer extends GeoEntityRenderer<PharaohEntity> {
	...
	@Override
	public Color getRenderColor(PharaohEntity animatable, float partialTick, int packedLight) {
		Color color = PharaohEntityRenderer.super.getRenderColor(animatable, partialTick, packedLight);
