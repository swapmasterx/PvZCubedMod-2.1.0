...
public class PharaohEntityRenderer extends GeoEntityRenderer<PharaohEntity> {
	...
	@Override
	public void preRender(MatrixStack poseStack, PharaohEntity animatable, BakedGeoModel model, VertexConsumerProvider bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue,
						  float alpha) {
