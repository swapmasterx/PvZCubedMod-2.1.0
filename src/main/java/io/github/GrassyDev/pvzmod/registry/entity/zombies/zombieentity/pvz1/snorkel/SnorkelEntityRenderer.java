...
public class SnorkelEntityRenderer extends GeoEntityRenderer<SnorkelEntity> {
	...
	@Override
	public void preRender(MatrixStack poseStack, SnorkelEntity animatable, BakedGeoModel model, VertexConsumerProvider bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue,
						  float alpha) {
