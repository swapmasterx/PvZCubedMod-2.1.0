...
public class SnorkelEntityRenderer extends GeoEntityRenderer<SnorkelEntity> {
	...
	@Override
	public Color getRenderColor(SnorkelEntity animatable, float partialTick, int packedLight) {
		Color color = SnorkelEntityRenderer.super.getRenderColor(animatable, partialTick, packedLight);
