...
public class DancingZombieEntity extends SummonerEntity implements GeoEntity {
	...
	public void tick() {
		...
		if (this.dancing && this.getAttributes().hasAttribute(EntityAttributes.GENERIC_MOVEMENT_SPEED) &&
...
//	}
	...
	protected abstract class CastSpellGoal extends Goal {
		...
		public boolean canStart() {
			...
			if (livingEntity != null && livingEntity.isAlive() && !DancingZombieEntity.this.hasStatusEffect(StatusHolder.FROZEN_HOLDER) && !DancingZombieEntity.this.hasStatusEffect(StatusHolder.STUN_HOLDER)) {
		...
		public boolean shouldContinue() {
			LivingEntity livingEntity = DancingZombieEntity.this.getTarget();
			return livingEntity != null && livingEntity.isAlive() && this.spellCooldown > 0 && !DancingZombieEntity.this.hasStatusEffect(StatusHolder.FROZEN_HOLDER) && !DancingZombieEntity.this.hasStatusEffect(StatusHolder.STUN_HOLDER) && DancingZombieEntity.this.getTypeCount() < 4;
		}
