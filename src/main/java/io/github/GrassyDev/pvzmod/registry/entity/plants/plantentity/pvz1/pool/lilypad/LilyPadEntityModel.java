...
public class LilyPadEntityModel extends GeoModel<LilyPadEntity> {
    ...
    {
        return Identifier.of("pvzmod", "geo/lilypad.geo.json");
    }

    @Override
    public Identifier getTextureResource(LilyPadEntity object)
    {
        return Identifier.of("pvzmod", "textures/entity/environment/lilypad.png");
    }

    @Override
    public Identifier getAnimationResource(LilyPadEntity object)
    {
        return Identifier.of ("pvzmod", "animations/lilypad.json");
    }
}
