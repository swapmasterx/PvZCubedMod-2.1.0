...
public class ScrapMechEntityRenderer extends GeoEntityRenderer<ScrapMechEntity> {
	...
	@Override
	public void preRender(MatrixStack poseStack, ScrapMechEntity animatable, BakedGeoModel model, VertexConsumerProvider bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue,
						  float alpha) {
