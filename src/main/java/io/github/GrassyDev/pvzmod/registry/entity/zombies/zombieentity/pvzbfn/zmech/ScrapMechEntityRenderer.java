...
public class ScrapMechEntityRenderer extends GeoEntityRenderer<ScrapMechEntity> {
	...
	@Override
	public Color getRenderColor(ScrapMechEntity animatable, float partialTick, int packedLight) {
		Color color = ScrapMechEntityRenderer.super.getRenderColor(animatable, partialTick, packedLight);
