...
public class BoneProjEntityRenderer extends GeoEntityRenderer<BoneProjEntity> {
	@Override
	public void preRender(MatrixStack poseStack, BoneProjEntity animatable, BakedGeoModel model, VertexConsumerProvider bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue,
						  float alpha) {
