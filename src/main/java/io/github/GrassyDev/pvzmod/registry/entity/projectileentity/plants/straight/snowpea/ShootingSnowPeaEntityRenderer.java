...
public class ShootingSnowPeaEntityRenderer extends GeoEntityRenderer<ShootingSnowPeaEntity> {
	@Override
	public void preRender(MatrixStack poseStack, ShootingSnowPeaEntity animatable, BakedGeoModel model, VertexConsumerProvider bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue,
						  float alpha) {
