...
public class PowerSwordItem extends Item {
    public PowerSwordItem(Settings settings) {
        super(settings);
    }
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (!world.isClient) {
            ShootingPowerSwordEntity proj = new ShootingPowerSwordEntity(PvZEntity.POWERSWORDPROJ, world);
