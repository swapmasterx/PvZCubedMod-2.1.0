...
public class ModItems {
    ...
    //Plant Spawn
	public static final Item GARDENINGGLOVE = new GardeningGloves(new Item.Settings().maxCount(1).rarity(Rarity.RARE));
    ...
    public static final Item PUFFSHROOM_SEED_PACKET = new PuffshroomSeeds(new Item.Settings().maxCount(16).rarity(Rarity.COMMON));
	...
	public static final Item LILYPAD_SEED_PACKET = new LilyPadSeeds(new Item.Settings().maxCount(16).rarity(Rarity.COMMON));
	...
	public static final Item COFFEEBEAN_SEED_PACKET = new CoffeeBeanSeeds(new Item.Settings().maxCount(16).rarity(Rarity.COMMON));
	public static final Item GATLINGPEA_SEED_PACKET = new GatlingpeaSeeds(new Item.Settings().maxCount(2).rarity(Rarity.EPIC));
	public static final Item TWINSUNFLOWER_SEED_PACKET = new TwinSunflowerSeeds(new Item.Settings().maxCount(2).rarity(Rarity.EPIC));
	public static final Item GLOOMSHROOM_SEED_PACKET = new GloomshroomSeeds(new Item.Settings().maxCount(2).rarity(Rarity.EPIC));
	public static final Item CATTAIL_SEED_PACKET = new CattailSeeds(new Item.Settings().maxCount(2).rarity(Rarity.EPIC));
	public static final Item SPIKEROCK_SEED_PACKET = new SpikerockSeeds(new Item.Settings().maxCount(2).rarity(Rarity.EPIC));
	...
	public static final Item SNOW_QUEENPEA_SEED_PACKET = new SnowqueenpeaSeeds(new Item.Settings().maxCount(2).rarity(Rarity.EPIC));
	...
	public static final Item CHESTER_SEED_PACKET = new ChesterSeeds(new Item.Settings().maxCount(4).rarity(Rarity.EPIC));
	...
	public static final Item RETROGATLING_SEED_PACKET = new RetroGatlingSeeds(new Item.Settings().maxCount(2).rarity(Rarity.EPIC));
	...
	public static final Item PERFOOMSHROOM_SEED_PACKET = new PerfoomshroomSeeds(new Item.Settings().maxCount(2).rarity(Rarity.EPIC));
	public static final Item BLOOMERANG_SEED_PACKET = new BloomerangSeeds(new Item.Settings().maxCount(2).rarity(Rarity.EPIC));
	public static final Item ICEBERGLETTUCE_SEED_PACKET = new IcebergLettuceSeeds(new Item.Settings().maxCount(16).rarity(Rarity.COMMON));
	...
	public static final Item PEAPOD_SEED_PACKET = new PeaPodSeeds(new Item.Settings().maxCount(16).rarity(Rarity.UNCOMMON));
	...
	public static final Item FIRE_PEA_SEED_PACKET = new FirepeaSeeds(new Item.Settings().maxCount(4).rarity(Rarity.EPIC));
	...
	public static final Item SHADOWSHROOM_SEED_PACKET = new ShadowShroomSeeds(new Item.Settings().maxCount(16).rarity(Rarity.COMMON));
	public static final Item MISSILETOE_SEED_PACKET = new MissileToeSeeds(new Item.Settings().maxCount(1).rarity(Rarity.EPIC));
	public static final Item ELECTROPEA_SEED_PACKET = new ElectropeaSeeds(new Item.Settings().maxCount(4).rarity(Rarity.EPIC));
	...
	public static final Item LOQUAT_SEED_PACKET = new LoquatSeeds(new Item.Settings().maxCount(16).rarity(Rarity.COMMON));
	...
	public static final Item MAGNETOSHROOM_SEED_PACKET = new MagnetoShroomSeeds(new Item.Settings().maxCount(1).rarity(Rarity.EPIC));
	public static final Item SMALLNUT_SEED_PACKET = new SmallnutSeeds(new Item.Settings().maxCount(16).rarity(Rarity.COMMON));
	...
	public static final Item LOCOCOCO_SEED_PACKET = new LocoCocoSeeds(new Item.Settings().maxCount(1).rarity(Rarity.EPIC));
	public static final Item BUTTONSHROOM_SEED_PACKET = new ButtonshroomSeeds(new Item.Settings().maxCount(16).rarity(Rarity.COMMON));
	public static final Item BOMBSEEDLING_SEED_PACKET = new BombSeedlingSeeds(new Item.Settings().maxCount(16).rarity(Rarity.COMMON));
	public static final Item OILYOLIVE_SEED_PACKET = new OilyOliveSeeds(new Item.Settings().maxCount(16).rarity(Rarity.COMMON));
	public static final Item ZAPRICOT_SEED_PACKET = new ZapricotSeeds(new Item.Settings().maxCount(16).rarity(Rarity.COMMON));
	public static final Item BANANASAURUS_SEED_PACKET = new BananasaurusSeeds(new Item.Settings().maxCount(1).rarity(Rarity.EPIC));
	public static final Item WEENIEBEANIE_SEED_PACKET = new WeenieBeanieSeeds(new Item.Settings().maxCount(16).rarity(Rarity.COMMON));
	public static final Item SMOOSHROOM_SEED_PACKET = new SmooshroomSeeds(new Item.Settings().maxCount(4).rarity(Rarity.EPIC));
	...
	public static final Item SUNFLOWERSEED_SEED_PACKET = new SunflowerSeedSeeds(new Item.Settings().maxCount(16).rarity(Rarity.COMMON));
	public static final Item BELLFLOWER_SEED_PACKET = new BellflowerSeeds(new Item.Settings().maxCount(8).rarity(Rarity.COMMON));
	public static final Item KNIGHTPEA_SEED_PACKET = new KnightPeaSeeds(new Item.Settings().maxCount(4).rarity(Rarity.EPIC));
	public static final Item SEAPEA_SEED_PACKET = new SeapeaSeeds(new Item.Settings().maxCount(8).rarity(Rarity.UNCOMMON));
	public static final Item NIGHTCAP_SEED_PACKET = new NightcapSeeds(new Item.Settings().maxCount(4).rarity(Rarity.EPIC));
	public static final Item DOOMROSE_SEED_PACKET = new DoomRoseSeeds(new Item.Settings().maxCount(4).rarity(Rarity.EPIC));
	public static final Item DOGWOOD_SEED_PACKET = new DogwoodSeeds(new Item.Settings().maxCount(8).rarity(Rarity.UNCOMMON));
	public static final Item GAMBLESHROOM_SEED_PACKET = new GambleshroomSeeds(new Item.Settings().maxCount(2).rarity(Rarity.EPIC));
