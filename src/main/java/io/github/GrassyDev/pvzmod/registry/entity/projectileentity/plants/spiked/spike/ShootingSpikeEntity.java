...
public class ShootingSpikeEntity extends PvZProjectileEntity implements GeoEntity {
    ...
    public static final Identifier PacketID = Identifier.of(PvZEntity.ModID, "spikeproj");
...
//				}
		...
		if (!this.getWorld().isClient && checkFilamint(this.getPos()) != null) {
			ShootingPowerSpikeEntity powerSpike = (ShootingPowerSpikeEntity) PvZEntity.POWERSPIKE.create(getWorld());
