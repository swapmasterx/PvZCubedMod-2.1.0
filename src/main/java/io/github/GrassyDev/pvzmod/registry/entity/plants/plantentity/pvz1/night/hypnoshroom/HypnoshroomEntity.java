...
public class HypnoshroomEntity extends PlantEntity implements GeoAnimatable, RangedAttackMob {
	...
	private <P extends GeoAnimatable> PlayState predicate(AnimationState<P> event) {
        if (this.getIsAsleep()) {
            event.getController().setAnimation(new RawAnimation().loop("hypnoshroom.asleep"));
        }
        else {
            event.getController().setAnimation(new RawAnimation().loop("hypnoshroom.idle"));
        }
