...
public class BasketballCarrierEntityRenderer extends GeoEntityRenderer<BasketballCarrierEntity> {
	...
	@Override
	public void preRender(MatrixStack poseStack, BasketballCarrierEntity animatable, BakedGeoModel model, VertexConsumerProvider bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue,
						  float alpha) {
