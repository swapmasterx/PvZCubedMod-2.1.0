...
public class BasketballCarrierEntityRenderer extends GeoEntityRenderer<BasketballCarrierEntity> {
	...
	@Override
	public Color getRenderColor(BasketballCarrierEntity animatable, float partialTick, int packedLight) {
		Color color = BasketballCarrierEntityRenderer.super.getRenderColor(animatable, partialTick, packedLight);
