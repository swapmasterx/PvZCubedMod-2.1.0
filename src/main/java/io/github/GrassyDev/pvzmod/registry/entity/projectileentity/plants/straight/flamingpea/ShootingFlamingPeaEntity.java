...
public class ShootingFlamingPeaEntity extends PvZProjectileEntity implements GeoEntity {
...
@Override
    ...
    public static final Identifier PacketID = Identifier.of(PvZEntity.ModID, "firepea");
    ...
    public ShootingFlamingPeaEntity(World world, double x, double y, double z, float yaw, float pitch, int interpolation, int id, UUID uuid) {
	...
	public void hitEntities() {
		...
		while (true) {
			...
			if (!getWorld().isClient && entity instanceof Monster monster &&
				...
				if ((entity instanceof ZombieShieldEntity || entity.isWet() || ((LivingEntity) entity).hasStatusEffect(StatusHolder.WET_HOLDER) ||
				...
				if (!entity.isWet() && !((LivingEntity) entity).hasStatusEffect(StatusHolder.WET_HOLDER) &&
					...
					while (true) {
						...
						do {
							...
							} while (livingEntity == (LivingEntity) this.getOwner());
