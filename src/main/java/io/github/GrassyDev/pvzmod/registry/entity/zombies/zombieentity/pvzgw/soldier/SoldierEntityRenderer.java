...
public class SoldierEntityRenderer extends GeoEntityRenderer<SoldierEntity> {
	...
	@Override
	public Color getRenderColor(SoldierEntity animatable, float partialTick, int packedLight) {
		Color color = SoldierEntityRenderer.super.getRenderColor(animatable, partialTick, packedLight);
