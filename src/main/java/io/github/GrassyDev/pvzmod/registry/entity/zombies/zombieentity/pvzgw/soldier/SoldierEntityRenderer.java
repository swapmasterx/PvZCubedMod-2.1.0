...
public class SoldierEntityRenderer extends GeoEntityRenderer<SoldierEntity> {
	...
	@Override
	public void preRender(MatrixStack poseStack, SoldierEntity animatable, BakedGeoModel model, VertexConsumerProvider bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue,
						  float alpha) {
