...
public class ScientistEntityRenderer extends GeoEntityRenderer<ScientistEntity> {
	...
	@Override
	public void preRender(MatrixStack poseStack, ScientistEntity animatable, BakedGeoModel model, VertexConsumerProvider bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue,
						  float alpha) {
