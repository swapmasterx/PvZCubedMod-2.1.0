...
public class ScientistEntityRenderer extends GeoEntityRenderer<ScientistEntity> {
	...
	@Override
	public Color getRenderColor(ScientistEntity animatable, float partialTick, int packedLight) {
		Color color = ScientistEntityRenderer.super.getRenderColor(animatable, partialTick, packedLight);
