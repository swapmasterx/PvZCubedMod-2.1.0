...
public class RoboConeEntityRenderer extends GeoEntityRenderer<RoboConeEntity> {
	...
	@Override
	public Color getRenderColor(RoboConeEntity animatable, float partialTick, int packedLight) {
		Color color = RoboConeEntityRenderer.super.getRenderColor(animatable, partialTick, packedLight);
