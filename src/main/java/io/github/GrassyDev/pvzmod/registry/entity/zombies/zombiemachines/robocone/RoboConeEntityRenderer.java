...
public class RoboConeEntityRenderer extends GeoEntityRenderer<RoboConeEntity> {
	...
	@Override
	public void preRender(MatrixStack poseStack, RoboConeEntity animatable, BakedGeoModel model, VertexConsumerProvider bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue,
						  float alpha) {
