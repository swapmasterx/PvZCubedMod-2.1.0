...
public class FlagPokerEntityRenderer extends GeoEntityRenderer<FlagPokerEntity> {
	...
	@Override
	public Color getRenderColor(FlagPokerEntity animatable, float partialTick, int packedLight) {
		Color color = FlagPokerEntityRenderer.super.getRenderColor(animatable, partialTick, packedLight);
