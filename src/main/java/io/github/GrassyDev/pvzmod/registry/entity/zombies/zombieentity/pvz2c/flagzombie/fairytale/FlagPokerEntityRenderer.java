...
public class FlagPokerEntityRenderer extends GeoEntityRenderer<FlagPokerEntity> {
	...
	@Override
	public void preRender(MatrixStack poseStack, FlagPokerEntity animatable, BakedGeoModel model, VertexConsumerProvider bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue,
						  float alpha) {
