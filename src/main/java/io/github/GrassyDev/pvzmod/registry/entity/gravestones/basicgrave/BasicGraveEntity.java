...
public class BasicGraveEntity extends GraveEntity implements GeoEntity {
	...
	class summonZombieGoal extends BasicGraveEntity.CastSpellGoal {
        ...
        protected void castSpell() {
			...
			LocalDifficulty localDifficulty = getWorld().getLocalDifficulty(this.basicGraveEntity.getBlockPos());
			double difficulty = 0;
            ...
            for(int b = 0; b < 1; ++b) { // 100% x1 Browncoat
                ...
                BlockPos blockPos = BasicGraveEntity.this.getBlockPos().add(zombiePos, 0, zombiePosZ);
