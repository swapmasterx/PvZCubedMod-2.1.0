...
public class ExplorerEntityRenderer extends GeoEntityRenderer<ExplorerEntity> {
	...
	@Override
	public void preRender(MatrixStack poseStack, ExplorerEntity animatable, BakedGeoModel model, VertexConsumerProvider bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue,
						  float alpha) {
