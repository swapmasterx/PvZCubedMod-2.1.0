...
public class ExplorerEntityRenderer extends GeoEntityRenderer<ExplorerEntity> {
	...
	@Override
	public Color getRenderColor(ExplorerEntity animatable, float partialTick, int packedLight) {
		Color color = ExplorerEntityRenderer.super.getRenderColor(animatable, partialTick, packedLight);
