...
public class FlagPeasantEntityRenderer extends GeoEntityRenderer<FlagPeasantEntity> {
	...
	@Override
	public Color getRenderColor(FlagPeasantEntity animatable, float partialTick, int packedLight) {
		Color color = FlagPeasantEntityRenderer.super.getRenderColor(animatable, partialTick, packedLight);
