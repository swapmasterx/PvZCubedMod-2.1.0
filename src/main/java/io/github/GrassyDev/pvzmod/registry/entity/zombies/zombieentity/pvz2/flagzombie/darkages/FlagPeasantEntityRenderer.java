...
public class FlagPeasantEntityRenderer extends GeoEntityRenderer<FlagPeasantEntity> {
	...
	@Override
	public void preRender(MatrixStack poseStack, FlagPeasantEntity animatable, BakedGeoModel model, VertexConsumerProvider bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue,
						  float alpha) {
