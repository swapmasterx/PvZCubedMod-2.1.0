...
public class DancingZombieEntityRenderer extends GeoEntityRenderer<DancingZombieEntity> {
	...
	@Override
	public void preRender(MatrixStack poseStack, DancingZombieEntity animatable, BakedGeoModel model, VertexConsumerProvider bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue,
						  float alpha) {
