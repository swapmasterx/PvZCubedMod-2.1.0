...
public class DancingZombieEntityRenderer extends GeoEntityRenderer<DancingZombieEntity> {
	...
	@Override
	public Color getRenderColor(DancingZombieEntity animatable, float partialTick, int packedLight) {
		Color color = DancingZombieEntityRenderer.super.getRenderColor(animatable, partialTick, packedLight);
