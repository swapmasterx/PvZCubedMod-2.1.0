...
public class PoleVaultingEntityRenderer extends GeoEntityRenderer<PoleVaultingEntity> {
	...
	@Override
	public Color getRenderColor(PoleVaultingEntity animatable, float partialTick, int packedLight) {
		Color color = PoleVaultingEntityRenderer.super.getRenderColor(animatable, partialTick, packedLight);
