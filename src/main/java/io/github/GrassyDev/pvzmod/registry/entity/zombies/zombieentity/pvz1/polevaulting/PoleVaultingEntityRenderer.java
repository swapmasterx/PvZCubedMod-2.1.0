...
public class PoleVaultingEntityRenderer extends GeoEntityRenderer<PoleVaultingEntity> {
	...
	@Override
	public void preRender(MatrixStack poseStack, PoleVaultingEntity animatable, BakedGeoModel model, VertexConsumerProvider bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue,
						  float alpha) {
