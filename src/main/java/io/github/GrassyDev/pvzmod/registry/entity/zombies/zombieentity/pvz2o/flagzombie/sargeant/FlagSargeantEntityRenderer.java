...
public class FlagSargeantEntityRenderer extends GeoEntityRenderer<FlagSargeantEntity> {
	...
	@Override
	public void preRender(MatrixStack poseStack, FlagSargeantEntity animatable, BakedGeoModel model, VertexConsumerProvider bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue,
						  float alpha) {
