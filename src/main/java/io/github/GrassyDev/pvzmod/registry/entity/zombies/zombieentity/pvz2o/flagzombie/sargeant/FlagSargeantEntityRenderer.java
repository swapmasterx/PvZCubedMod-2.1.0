...
public class FlagSargeantEntityRenderer extends GeoEntityRenderer<FlagSargeantEntity> {
	...
	@Override
	public Color getRenderColor(FlagSargeantEntity animatable, float partialTick, int packedLight) {
		Color color = FlagSargeantEntityRenderer.super.getRenderColor(animatable, partialTick, packedLight);
