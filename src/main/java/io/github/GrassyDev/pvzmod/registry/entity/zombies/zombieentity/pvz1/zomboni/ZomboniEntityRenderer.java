...
public class ZomboniEntityRenderer extends GeoEntityRenderer<ZomboniEntity> {
	...
	@Override
	public void preRender(MatrixStack poseStack, ZomboniEntity animatable, BakedGeoModel model, VertexConsumerProvider bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue,
						  float alpha) {
