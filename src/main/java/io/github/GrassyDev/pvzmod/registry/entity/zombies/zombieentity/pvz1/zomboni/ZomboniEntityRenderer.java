...
public class ZomboniEntityRenderer extends GeoEntityRenderer<ZomboniEntity> {
	...
	@Override
	public Color getRenderColor(ZomboniEntity animatable, float partialTick, int packedLight) {
		Color color = ZomboniEntityRenderer.super.getRenderColor(animatable, partialTick, packedLight);
