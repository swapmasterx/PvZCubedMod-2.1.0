...
public class ShootingBasketballEntity extends PvZProjectileEntity implements GeoEntity {
				...
				if (entity != this && !(entity instanceof PlantEntity plantEntity && plantEntity.getImmune())) {
					if (!this.isHypno) {
						if (!getWorld().isClient &&
							...
							float damage = 4F * damageMultiplier;
							if (damage > ((LivingEntity) entity).getHealth() &&
								...
								generalPvZombieEntity1.damage(getDamageSources().mobProjectile(this, (LivingEntity) this.getOwner()), damage2);
							} else {
								entity.damage(getDamageSources().mobProjectile(this, (LivingEntity) this.getOwner()), damage);
							}
							this.getWorld().sendEntityStatus(this, (byte) 3);
