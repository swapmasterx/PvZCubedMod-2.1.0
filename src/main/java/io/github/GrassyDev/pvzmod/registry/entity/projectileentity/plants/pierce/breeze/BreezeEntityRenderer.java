...
public class BreezeEntityRenderer extends GeoEntityRenderer<BreezeEntity> {
	@Override
	public void preRender(MatrixStack poseStack, BreezeEntity animatable, BakedGeoModel model, VertexConsumerProvider bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue,
						  float alpha) {
