...
public class AnnouncerImpEntityRenderer extends GeoEntityRenderer<AnnouncerImpEntity> {
	...
	@Override
	public Color getRenderColor(AnnouncerImpEntity animatable, float partialTick, int packedLight) {
		Color color = AnnouncerImpEntityRenderer.super.getRenderColor(animatable, partialTick, packedLight);
