...
public class AnnouncerImpEntityRenderer extends GeoEntityRenderer<AnnouncerImpEntity> {
	...
	@Override
	public void preRender(MatrixStack poseStack, AnnouncerImpEntity animatable, BakedGeoModel model, VertexConsumerProvider bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue,
						  float alpha) {
