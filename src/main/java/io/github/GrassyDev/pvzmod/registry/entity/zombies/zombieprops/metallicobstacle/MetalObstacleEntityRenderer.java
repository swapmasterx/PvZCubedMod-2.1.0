...
public class MetalObstacleEntityRenderer extends GeoEntityRenderer<MetalObstacleEntity> {
	...
	@Override
	public void preRender(MatrixStack poseStack, MetalObstacleEntity animatable, BakedGeoModel model, VertexConsumerProvider bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue,
						  float alpha) {
