...
public class MetalObstacleEntityRenderer extends GeoEntityRenderer<MetalObstacleEntity> {
	...
	@Override
	public Color getRenderColor(MetalObstacleEntity animatable, float partialTick, int packedLight) {
		Color color = MetalObstacleEntityRenderer.super.getRenderColor(animatable, partialTick, packedLight);
