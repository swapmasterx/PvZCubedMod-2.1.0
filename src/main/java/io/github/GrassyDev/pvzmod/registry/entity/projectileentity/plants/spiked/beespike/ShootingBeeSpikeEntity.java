...
public class ShootingBeeSpikeEntity extends PvZProjectileEntity implements GeoAnimatable {
    ...
    public void tick() {
		...
		if (!this.getWorld().isClient && checkFilamint(this.getPos()) != null) {
			ShootingPowerBeeSpikeEntity powerSpike = (ShootingPowerBeeSpikeEntity) PvZEntity.POWERBEESPIKE.create(getWorld());
