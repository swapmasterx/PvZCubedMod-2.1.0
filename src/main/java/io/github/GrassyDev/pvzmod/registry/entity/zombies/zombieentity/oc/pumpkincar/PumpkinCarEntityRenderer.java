...
public class PumpkinCarEntityRenderer extends GeoEntityRenderer<PumpkinCarEntity> {
	...
	@Override
	public Color getRenderColor(PumpkinCarEntity animatable, float partialTick, int packedLight) {
		Color color = PumpkinCarEntityRenderer.super.getRenderColor(animatable, partialTick, packedLight);
