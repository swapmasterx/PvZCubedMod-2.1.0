...
public class PumpkinCarEntityRenderer extends GeoEntityRenderer<PumpkinCarEntity> {
	...
	@Override
	public void preRender(MatrixStack poseStack, PumpkinCarEntity animatable, BakedGeoModel model, VertexConsumerProvider bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue,
						  float alpha) {
