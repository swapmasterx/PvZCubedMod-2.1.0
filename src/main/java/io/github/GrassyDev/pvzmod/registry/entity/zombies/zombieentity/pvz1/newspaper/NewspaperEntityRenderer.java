...
public class NewspaperEntityRenderer extends GeoEntityRenderer<NewspaperEntity> {
	...
	@Override
	public void preRender(MatrixStack poseStack, NewspaperEntity animatable, BakedGeoModel model, VertexConsumerProvider bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue,
						  float alpha) {
