...
public class NewspaperEntityRenderer extends GeoEntityRenderer<NewspaperEntity> {
	...
	@Override
	public Color getRenderColor(NewspaperEntity animatable, float partialTick, int packedLight) {
		Color color = NewspaperEntityRenderer.super.getRenderColor(animatable, partialTick, packedLight);
