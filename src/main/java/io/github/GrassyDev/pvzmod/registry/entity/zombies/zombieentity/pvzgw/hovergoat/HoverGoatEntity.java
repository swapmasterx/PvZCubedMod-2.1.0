...
public class HoverGoatEntity extends PvZombieEntity implements GeoAnimatable {
	...
	private <P extends GeoAnimatable> PlayState predicate(AnimationState<P> event) {
		event.getController().setAnimation(new RawAnimation().loop("hovergoat.idle"));
		if (this.isFrozen || this.isStunned) {
			event.getController().setAnimation(new RawAnimation().loop("hovergoat.stun"));
