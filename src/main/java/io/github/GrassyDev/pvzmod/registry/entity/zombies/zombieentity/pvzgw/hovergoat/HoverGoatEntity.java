...
public class HoverGoatEntity extends PvZombieEntity implements IAnimatable {
	...
	private <P extends IAnimatable> PlayState predicate(AnimationEvent<P> event) {
		event.getController().setAnimation(new AnimationBuilder().loop("hovergoat.idle"));
		if (this.isFrozen || this.isStunned) {
			event.getController().setAnimation(new AnimationBuilder().loop("hovergoat.stun"));
	...
	public boolean damage(DamageSource source, float amount) {
        if (!super.damage(source, amount)) {
            ...
            if (this.getRecentDamageSource() == PvZCubed.HYPNO_DAMAGE && !(this.getHypno())) {
                ...
                HoverGoatEntity hypnotizedZombie = (HoverGoatEntity) hypnoType.create(world);
