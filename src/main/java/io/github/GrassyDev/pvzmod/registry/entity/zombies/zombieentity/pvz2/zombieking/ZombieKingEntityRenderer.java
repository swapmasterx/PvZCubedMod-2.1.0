...
public class ZombieKingEntityRenderer extends GeoEntityRenderer<ZombieKingEntity> {
	...
	@Override
	public void preRender(MatrixStack poseStack, ZombieKingEntity animatable, BakedGeoModel model, VertexConsumerProvider bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue,
						  float alpha) {
