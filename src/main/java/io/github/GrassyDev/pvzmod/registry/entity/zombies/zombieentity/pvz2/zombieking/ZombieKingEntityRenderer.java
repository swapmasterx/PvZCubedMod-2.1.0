...
public class ZombieKingEntityRenderer extends GeoEntityRenderer<ZombieKingEntity> {
	...
	@Override
	public Color getRenderColor(ZombieKingEntity animatable, float partialTick, int packedLight) {
		Color color = ZombieKingEntityRenderer.super.getRenderColor(animatable, partialTick, packedLight);
