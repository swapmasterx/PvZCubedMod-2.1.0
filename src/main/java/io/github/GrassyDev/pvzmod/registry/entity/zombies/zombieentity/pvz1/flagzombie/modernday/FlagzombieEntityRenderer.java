...
public class FlagzombieEntityRenderer extends GeoEntityRenderer<FlagzombieEntity> {
	...
	@Override
	public Color getRenderColor(FlagzombieEntity animatable, float partialTick, int packedLight) {
		Color color = FlagzombieEntityRenderer.super.getRenderColor(animatable, partialTick, packedLight);
