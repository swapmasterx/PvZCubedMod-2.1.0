...
public class FlagzombieEntityRenderer extends GeoEntityRenderer<FlagzombieEntity> {
	...
	@Override
	public void preRender(MatrixStack poseStack, FlagzombieEntity animatable, BakedGeoModel model, VertexConsumerProvider bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue,
						  float alpha) {
