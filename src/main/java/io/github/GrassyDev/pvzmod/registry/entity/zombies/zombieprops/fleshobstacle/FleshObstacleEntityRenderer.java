...
public class FleshObstacleEntityRenderer extends GeoEntityRenderer<FleshObstacleEntity> {
	...
	@Override
	public void preRender(MatrixStack poseStack, FleshObstacleEntity animatable, BakedGeoModel model, VertexConsumerProvider bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue,
						  float alpha) {
