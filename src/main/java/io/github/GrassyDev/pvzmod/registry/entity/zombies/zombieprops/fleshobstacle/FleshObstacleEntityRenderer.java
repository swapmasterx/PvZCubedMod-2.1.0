...
public class FleshObstacleEntityRenderer extends GeoEntityRenderer<FleshObstacleEntity> {
	...
	@Override
	public Color getRenderColor(FleshObstacleEntity animatable, float partialTick, int packedLight) {
		Color color = FleshObstacleEntityRenderer.super.getRenderColor(animatable, partialTick, packedLight);
