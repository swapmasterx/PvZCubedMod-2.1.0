...
public class ShootingFrisbeeEntity extends PvZProjectileEntity implements GeoEntity {
    ...
    public static final Identifier PacketID = Identifier.of(PvZEntity.ModID, "frisbeeproj");
