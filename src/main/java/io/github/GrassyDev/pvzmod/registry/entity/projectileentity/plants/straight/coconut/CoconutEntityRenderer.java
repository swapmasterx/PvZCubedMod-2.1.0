...
public class CoconutEntityRenderer extends GeoEntityRenderer <CoconutEntity>{
	@Override
	public void preRender(MatrixStack poseStack, CoconutEntity animatable, BakedGeoModel model, VertexConsumerProvider bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue,
						  float alpha) {
