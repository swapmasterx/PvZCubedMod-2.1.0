...
public class BackupDancerEntityRenderer extends GeoEntityRenderer<BackupDancerEntity> {
	...
	@Override
	public Color getRenderColor(BackupDancerEntity animatable, float partialTick, int packedLight) {
		Color color = BackupDancerEntityRenderer.super.getRenderColor(animatable, partialTick, packedLight);
