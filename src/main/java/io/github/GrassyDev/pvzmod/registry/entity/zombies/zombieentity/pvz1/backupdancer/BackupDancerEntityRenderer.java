...
public class BackupDancerEntityRenderer extends GeoEntityRenderer<BackupDancerEntity> {
	...
	@Override
	public void preRender(MatrixStack poseStack, BackupDancerEntity animatable, BakedGeoModel model, VertexConsumerProvider bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue,
						  float alpha) {
