...
public class PiercePeaEntity extends PvZProjectileEntity implements GeoEntity {
...
@Override
    ...
    public static final Identifier PacketID = Identifier.of(PvZEntity.ModID, "piercepea");
