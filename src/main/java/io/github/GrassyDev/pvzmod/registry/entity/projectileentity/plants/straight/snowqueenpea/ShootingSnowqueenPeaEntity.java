...
public class ShootingSnowqueenPeaEntity extends PvZProjectileEntity implements GeoEntity {
...
@Override
    ...
    public ShootingSnowqueenPeaEntity(World world, double x, double y, double z, float yaw, float pitch, int interpolation, int id, UUID uuid) {
