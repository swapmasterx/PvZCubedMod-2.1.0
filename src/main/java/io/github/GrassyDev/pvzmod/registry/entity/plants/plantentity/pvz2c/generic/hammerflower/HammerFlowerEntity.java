...
public class HammerFlowerEntity extends PlantEntity implements GeoAnimatable, RangedAttackMob {
	...
	private <P extends GeoAnimatable> PlayState predicate(AnimationState<P> event) {
		if (this.isFiring) {
			event.getController().setAnimation(new RawAnimation().playOnce("hammerflower.attack"));
		} else {
			event.getController().setAnimation(new RawAnimation().loop("hammerflower.idle"));
		}
