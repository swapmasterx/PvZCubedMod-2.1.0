...
public class OctoEntityRenderer extends GeoEntityRenderer<OctoEntity> {
	...
	@Override
	public Color getRenderColor(OctoEntity animatable, float partialTick, int packedLight) {
		Color color = OctoEntityRenderer.super.getRenderColor(animatable, partialTick, packedLight);
