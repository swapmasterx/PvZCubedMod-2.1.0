...
public class DolphinRiderEntityRenderer extends GeoEntityRenderer<DolphinRiderEntity> {
	...
	@Override
	public Color getRenderColor(DolphinRiderEntity animatable, float partialTick, int packedLight) {
		Color color = DolphinRiderEntityRenderer.super.getRenderColor(animatable, partialTick, packedLight);
