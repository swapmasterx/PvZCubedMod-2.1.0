...
public class DolphinRiderEntityRenderer extends GeoEntityRenderer<DolphinRiderEntity> {
	...
	@Override
	public void preRender(MatrixStack poseStack, DolphinRiderEntity animatable, BakedGeoModel model, VertexConsumerProvider bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue,
						  float alpha) {
