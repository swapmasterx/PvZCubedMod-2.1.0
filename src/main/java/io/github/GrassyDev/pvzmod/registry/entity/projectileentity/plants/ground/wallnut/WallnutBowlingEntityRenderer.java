...
public class WallnutBowlingEntityRenderer extends GeoEntityRenderer<WallnutBowlingEntity> {
	@Override
	public void preRender(MatrixStack poseStack, WallnutBowlingEntity animatable, BakedGeoModel model, VertexConsumerProvider bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue,
						  float alpha) {
