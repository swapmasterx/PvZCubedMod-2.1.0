...
public class ZomblobEntityRenderer extends GeoEntityRenderer<ZomblobEntity> {
	...
	@Override
	public Color getRenderColor(ZomblobEntity animatable, float partialTick, int packedLight) {
		Color color = ZomblobEntityRenderer.super.getRenderColor(animatable, partialTick, packedLight);
