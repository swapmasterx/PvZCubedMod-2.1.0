...
public class FlagSummerEntityRenderer extends GeoEntityRenderer<FlagSummerEntity> {
	...
	@Override
	public void preRender(MatrixStack poseStack, FlagSummerEntity animatable, BakedGeoModel model, VertexConsumerProvider bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue,
						  float alpha) {
