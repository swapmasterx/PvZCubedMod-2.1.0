...
public class FlagSummerEntityRenderer extends GeoEntityRenderer<FlagSummerEntity> {
	...
	@Override
	public Color getRenderColor(FlagSummerEntity animatable, float partialTick, int packedLight) {
		Color color = FlagSummerEntityRenderer.super.getRenderColor(animatable, partialTick, packedLight);
