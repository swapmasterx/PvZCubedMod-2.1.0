...
public class HawkerZombieEntityRenderer extends GeoEntityRenderer<HawkerZombieEntity> {
	...
	@Override
	public void preRender(MatrixStack poseStack, HawkerZombieEntity animatable, BakedGeoModel model, VertexConsumerProvider bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue,
						  float alpha) {
