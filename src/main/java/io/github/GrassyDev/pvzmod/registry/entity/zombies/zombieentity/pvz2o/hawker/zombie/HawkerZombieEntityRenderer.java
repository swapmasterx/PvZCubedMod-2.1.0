...
public class HawkerZombieEntityRenderer extends GeoEntityRenderer<HawkerZombieEntity> {
	...
	@Override
	public Color getRenderColor(HawkerZombieEntity animatable, float partialTick, int packedLight) {
		Color color = HawkerZombieEntityRenderer.super.getRenderColor(animatable, partialTick, packedLight);
