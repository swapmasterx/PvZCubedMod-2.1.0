...
public class KnightPeaEntity extends PlantEntity implements GeoAnimatable, RangedAttackMob {
    ...
    public KnightPeaEntity(EntityType<? extends KnightPeaEntity> entityType, World world) {
	...
	public ItemStack getPickBlockStack() {
		return ModItems.KNIGHTPEA_SEED_PACKET.getDefaultStack();
	}
