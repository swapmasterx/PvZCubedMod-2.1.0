...
public class BobsledEntityRenderer extends GeoEntityRenderer<BobsledRiderEntity> {
	...
	@Override
	public Color getRenderColor(BobsledRiderEntity animatable, float partialTick, int packedLight) {
		Color color = BobsledEntityRenderer.super.getRenderColor(animatable, partialTick, packedLight);
