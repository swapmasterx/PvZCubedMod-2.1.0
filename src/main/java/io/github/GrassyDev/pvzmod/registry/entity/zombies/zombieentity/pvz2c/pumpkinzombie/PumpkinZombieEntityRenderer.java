...
public class PumpkinZombieEntityRenderer extends GeoEntityRenderer<PumpkinZombieEntity> {
	...
	@Override
	public void preRender(MatrixStack poseStack, PumpkinZombieEntity animatable, BakedGeoModel model, VertexConsumerProvider bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue,
						  float alpha) {
