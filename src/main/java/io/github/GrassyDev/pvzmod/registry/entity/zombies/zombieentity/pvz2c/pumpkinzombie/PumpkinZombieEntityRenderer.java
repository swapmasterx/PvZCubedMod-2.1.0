...
public class PumpkinZombieEntityRenderer extends GeoEntityRenderer<PumpkinZombieEntity> {
	...
	@Override
	public Color getRenderColor(PumpkinZombieEntity animatable, float partialTick, int packedLight) {
		Color color = PumpkinZombieEntityRenderer.super.getRenderColor(animatable, partialTick, packedLight);
