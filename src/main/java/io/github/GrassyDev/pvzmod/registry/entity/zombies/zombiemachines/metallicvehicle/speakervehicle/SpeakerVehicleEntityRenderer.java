...
public class SpeakerVehicleEntityRenderer extends GeoEntityRenderer<SpeakerVehicleEntity> {
	...
	@Override
	public void preRender(MatrixStack poseStack, SpeakerVehicleEntity animatable, BakedGeoModel model, VertexConsumerProvider bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue,
						  float alpha) {
