...
public class SpeakerVehicleEntityRenderer extends GeoEntityRenderer<SpeakerVehicleEntity> {
	...
	@Override
	public Color getRenderColor(SpeakerVehicleEntity animatable, float partialTick, int packedLight) {
		Color color = SpeakerVehicleEntityRenderer.super.getRenderColor(animatable, partialTick, packedLight);
