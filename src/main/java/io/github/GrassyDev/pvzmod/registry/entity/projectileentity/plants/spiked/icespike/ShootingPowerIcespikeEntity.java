...
public class ShootingPowerIcespikeEntity extends PvZProjectileEntity implements GeoEntity {
    ...
    public ShootingPowerIcespikeEntity(World world, double x, double y, double z, float yaw, float pitch, int interpolation, int id, UUID uuid) {
