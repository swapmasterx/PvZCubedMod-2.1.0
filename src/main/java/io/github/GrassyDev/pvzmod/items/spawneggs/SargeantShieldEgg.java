...
public class SargeantShieldEgg extends SeedItem {
	...
	public ActionResult useOnBlock(ItemUsageContext context) {
		...
		if (world.isSpaceEmpty((Entity) null, box) && world instanceof ServerWorld serverWorld) {
				SargeantEntity zombieEntity = (SargeantEntity) PvZEntity.SARGEANTSHIELD.spawnFromItemStack((ServerWorld)world, itemStack, context.getPlayer(), blockPos, SpawnReason.SPAWN_EGG, true, true);
