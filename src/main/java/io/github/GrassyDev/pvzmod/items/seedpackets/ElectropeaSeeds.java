...
public class ElectropeaSeeds extends SeedItem implements FabricItem {
	...
	public ActionResult useOnEntity(ItemStack stack, PlayerEntity user, LivingEntity entity, Hand hand) {
		...
		if (world instanceof ServerWorld serverWorld && entity instanceof TileEntity
			...
			ElectropeaEntity plantEntity = PvZEntity.ELECTROPEA.spawnFromItemStack((ServerWorld)world, stack, user, blockPos, SpawnReason.SPAWN_EGG, true, true);
			List<PlantEntity> list = world.getNonSpectatingEntities(PlantEntity.class, PvZEntity.ELECTROPEA.getDimensions().getBoxAt(plantEntity.getPos()));
			if (list.isEmpty()) {
			...
			ElectropeaEntity plantEntity = (ElectropeaEntity) PvZEntity.ELECTROPEA.spawnFromItemStack((ServerWorld)world, stack, user, blockPos, SpawnReason.SPAWN_EGG, true, true);
			if (plantEntity == null) {
				return ActionResult.FAIL;
			}
