...
public class SmooshroomSeeds extends SeedItem implements FabricItem {
	...
	public ActionResult useOnEntity(ItemStack stack, PlayerEntity user, LivingEntity entity, Hand hand) {
		...
		if (world instanceof ServerWorld serverWorld && entity instanceof TileEntity
			...
			SmooshroomEntity plantEntity = PvZEntity.SMOOSHROOM.spawnFromItemStack((ServerWorld) world, stack, user, blockPos, SpawnReason.SPAWN_EGG, true, true);
			List<PlantEntity> list = world.getNonSpectatingEntities(PlantEntity.class, PvZEntity.SMOOSHROOM.getDimensions().getBoxAt(plantEntity.getPos()));
			if (list.isEmpty()) {
			...
			SmooshroomEntity plantEntity = (SmooshroomEntity) PvZEntity.SMOOSHROOM.spawnFromItemStack((ServerWorld)world, stack, user, blockPos, SpawnReason.SPAWN_EGG, true, true);
			if (plantEntity == null) {
				return ActionResult.FAIL;
			}
