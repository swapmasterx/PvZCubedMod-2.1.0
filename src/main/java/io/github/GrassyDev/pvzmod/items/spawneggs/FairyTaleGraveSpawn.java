...
public class FairyTaleGraveSpawn extends SeedItem {
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
		...
		if (world.isSpaceEmpty((Entity)null, box) && world instanceof ServerWorld serverWorld) {
                    FairyTaleGraveEntity basicGraveEntity = (FairyTaleGraveEntity) PvZEntity.FAIRYTALEGRAVESTONE.spawnFromItemStack((ServerWorld)world, itemStack, context.getPlayer(), blockPos, SpawnReason.SPAWN_EGG, true, true);
