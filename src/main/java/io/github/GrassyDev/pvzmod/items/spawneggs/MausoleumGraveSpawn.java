...
public class MausoleumGraveSpawn extends SeedItem {
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
		...
		if (world.isSpaceEmpty((Entity)null, box) && world instanceof ServerWorld serverWorld) {
                    MausoleumGraveEntity basicGraveEntity = (MausoleumGraveEntity) PvZEntity.MAUSOLEUMGRAVESTONE.spawnFromItemStack((ServerWorld)world, itemStack, context.getPlayer(), blockPos, SpawnReason.SPAWN_EGG, true, true);
