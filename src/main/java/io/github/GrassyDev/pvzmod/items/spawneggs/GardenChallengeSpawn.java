...
public class GardenChallengeSpawn extends SeedItem {
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
		...
		if (world.isSpaceEmpty((Entity)null, box) && world instanceof ServerWorld serverWorld) {
			GardenChallengeEntity gardenEntity = (GardenChallengeEntity) PvZEntity.GARDENCHALLENGE.spawnFromItemStack((ServerWorld)world, itemStack, context.getPlayer(), blockPos, SpawnReason.SPAWN_EGG, true, true);
