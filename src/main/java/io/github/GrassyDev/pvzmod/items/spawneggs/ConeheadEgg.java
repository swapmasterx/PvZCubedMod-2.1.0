...
public class ConeheadEgg extends SeedItem {
	...
	public ActionResult useOnBlock(ItemUsageContext context) {
		...
		if (world.isSpaceEmpty((Entity) null, box) && world instanceof ServerWorld serverWorld) {
				BrowncoatEntity zombieEntity = (BrowncoatEntity) PvZEntity.CONEHEAD.spawnFromItemStack((ServerWorld)world, itemStack, context.getPlayer(), blockPos, SpawnReason.SPAWN_EGG, true, true);
