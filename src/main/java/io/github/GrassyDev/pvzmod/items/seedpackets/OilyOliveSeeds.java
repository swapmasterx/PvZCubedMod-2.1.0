...
public class OilyOliveSeeds extends SeedItem implements FabricItem {
	...
	public OilyOliveSeeds(Item.Settings settings) {
		super(settings);
	}
...
//	}
	...
	public ActionResult useOnEntity(ItemStack stack, PlayerEntity user, LivingEntity entity, Hand hand) {
		...
		if (world instanceof ServerWorld serverWorld && entity instanceof TileEntity
			...
			if (list.isEmpty()) {
				plantEntity = PvZEntity.OILYOLIVE.spawnFromItemStack((ServerWorld)world, stack, user, blockPos, SpawnReason.SPAWN_EGG, true, true);
