...
public class ModItems {
	...
	public static final Item PLANTFOOD_ELEC = new Item(new Item.Settings().maxCount(64));
	...
	public static final Item PLANTFOOD_SHADOW = new Item(new Item.Settings().maxCount(64));


    public static final Item PEA = new PeaItem(new Item.Settings().maxCount(16).rarity(Rarity.COMMON));
    public static final Item SPORE = new SporeItem(new Item.Settings().maxCount(16).rarity(Rarity.COMMON));
    public static final Item FUME = new FumeItem(new Item.Settings().maxCount(32).rarity(Rarity.COMMON));
	public static final Item BREEZE = new BreezeItem(new Item.Settings().maxCount(16).rarity(Rarity.UNCOMMON));
	...
	public static final Item HYPNO = new HypnoItem(new Item.Settings().maxCount(16).rarity(Rarity.EPIC));
	public static final Item ACIDSPORE = new AcidSporeItem(new Item.Settings().maxCount(16).rarity(Rarity.UNCOMMON));
	...
	public static final Item FRISBEE = new FrisbeeItem(new Item.Settings().maxCount(16).rarity(Rarity.UNCOMMON));
	public static final Item COCONUT = new CoconutItem(new Item.Settings().maxCount(16).rarity(Rarity.RARE));
	public static final Item PEPPER = new PepperItem(new Item.Settings().maxCount(16).rarity(Rarity.UNCOMMON));
	...
	public static final Item SPIKE = new SpikeItem(new Item.Settings().maxCount(16).rarity(Rarity.COMMON));
	public static final Item POWERSPIKE = new ElecSpikeItem(new Item.Settings().maxCount(16).rarity(Rarity.RARE));
	public static final Item SPRINGHAIR = new SpringHairItem(new Item.Settings().maxCount(16).rarity(Rarity.UNCOMMON));
	public static final Item ICESPIKE = new IcespikeItem(new Item.Settings().maxCount(16).rarity(Rarity.EPIC));
	public static final Item POWERICESPIKE = new PowerIceSpikeItem(new Item.Settings().maxCount(16).rarity(Rarity.EPIC));
	public static final Item RAINBOWBULLET = new RainbowBulletItem(new Item.Settings().maxCount(16).rarity(Rarity.UNCOMMON));
	public static final Item BEESPIKE = new BeeSpikeItem(new Item.Settings().maxCount(16).rarity(Rarity.EPIC));
	public static final Item POWERBEESPIKE = new PowerBeeSpikeItem(new Item.Settings().maxCount(16).rarity(Rarity.EPIC));
	public static final Item PUMPKINPROJ = new PumpkinItem(new Item.Settings().maxCount(16).rarity(Rarity.RARE));
	public static final Item HYPNOPROJ = new HypnoprojItem(new Item.Settings().maxCount(16).rarity(Rarity.RARE));
	public static final Item CARDPROJ = new CardItem(new Item.Settings().maxCount(64).rarity(Rarity.COMMON));
	public static final Item GOLDENCARDPROJ = new GoldenCardItem(new Item.Settings().maxCount(16).rarity(Rarity.RARE));
	public static final Item BUBBLES = new BubblesItem(new Item.Settings().maxCount(16).rarity(Rarity.COMMON));
	public static final Item ARMORBUBBLE = new ArmorBubbleItem(new Item.Settings().maxCount(16).rarity(Rarity.UNCOMMON));
	public static final Item DYEITEM = new DyeItem(new Item.Settings().maxCount(16).rarity(Rarity.RARE));
	public static final Item SMOOSH = new HammerItem(new Item.Settings().maxCount(16).rarity(Rarity.EPIC));
	public static final Item SPIT = new SpitItem(new Item.Settings().maxCount(16).rarity(Rarity.COMMON));
	public static final Item JINGLE = new JingleItem(new Item.Settings().maxCount(16).rarity(Rarity.COMMON));
	public static final Item SWORDPROJ = new SwordItem(new Item.Settings().maxCount(16).rarity(Rarity.UNCOMMON));
	public static final Item POWERSWORDPROJ = new PowerSwordItem(new Item.Settings().maxCount(16).rarity(Rarity.UNCOMMON));
	public static final Item PIERCESPORE = new PierceSporeItem(new Item.Settings().maxCount(16).rarity(Rarity.UNCOMMON));
	public static final Item PIERCESPORESHADOW = new PierceSporeShadowItem(new Item.Settings().maxCount(16).rarity(Rarity.RARE));
	public static final Item BARK = new BarkItem(new Item.Settings().maxCount(16).rarity(Rarity.COMMON));
    ...
    //Plant Spawn
	public static final Item GARDENINGGLOVE = new GardeningGloves(new Item.Settings().maxCount(64).rarity(Rarity.RARE));
	...
	public static final Item EMPTY_UPGRADE_PACKET = new Item(new Item.Settings().maxCount(64).rarity(Rarity.EPIC));
	public static final Item EMPTY_PREMIUM_PACKET = new Item(new Item.Settings().maxCount(64).rarity(Rarity.EPIC));
	public static final Item UPGRADE_PACKET_FRAGMENT = new Item(new Item.Settings().maxCount(64).rarity(Rarity.UNCOMMON));
    ...
    public static void registerItems() {
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"botany_station"), BOTANY_STATION);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"upgrade_packet_fragment"), UPGRADE_PACKET_FRAGMENT);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"empty_upgrade_packet"), EMPTY_UPGRADE_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"empty_seed_packet"), EMPTY_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"empty_premium_packet"), EMPTY_PREMIUM_PACKET);
        Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"icon_almanac"), ALMANAC);
        Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"plantfood"), PLANTFOOD);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"plantfood_air"), PLANTFOOD_AIR);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"plantfood_aquatic"), PLANTFOOD_AQUATIC);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"plantfood_cold"), PLANTFOOD_COLD);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"plantfood_elec"), PLANTFOOD_ELEC);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"plantfood_fire"), PLANTFOOD_FIRE);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"plantfood_flower"), PLANTFOOD_FLOWER);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"plantfood_mushroom"), PLANTFOOD_MUSHROOM);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"plantfood_tough"), PLANTFOOD_TOUGH);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"plantfood_shadow"), PLANTFOOD_SHADOW);
        Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"pea"), PEA);
        Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"spore"), SPORE);
        Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"fume"), FUME);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"breeze"), BREEZE);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"piercepea"), PIERCEPEA);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"firepiercepea"), FIREPIERCEPEA);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"acidfume"), ACIDFUME);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"hypno"), HYPNO);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"acidspore"), ACIDSPORE);
        Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"snowpeaproj"), SNOWPEAPROJ);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"firepea"), FIREPEA);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"cabbage"), CABBAGE);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"melon"), MELON);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"melon_slice"), MELONSLICE);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"ice_melon"), WINTERMELON);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"iceberg"), ICEBERG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"snowqueenpeaproj"), SNOWQUEENPEAPROJ);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"boomerangproj"), BOOMERANG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"frisbee"), FRISBEE);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"coconut"), COCONUT);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"pepper"), PEPPER);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"plasmapea"), PLASMAPEA);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"electricpea"), ELECTRICPEA);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"rainbowbullet"), RAINBOWBULLET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"beespike"), BEESPIKE);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"spike"), SPIKE);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"icespike"), ICESPIKE);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"powerbeespike"), POWERBEESPIKE);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"elecspike"), POWERSPIKE);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"springhair"), SPRINGHAIR);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"powericespike"), POWERICESPIKE);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"cardproj"), CARDPROJ);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"goldencardproj"), GOLDENCARDPROJ);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"hypnoproj"), HYPNOPROJ);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"pumpkinproj"), PUMPKINPROJ);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"bubblesitem"), BUBBLES);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"armorbubbleitem"), ARMORBUBBLE);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"dyeitem"), DYEITEM);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"hammer"), SMOOSH);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"spit"), SPIT);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"jingle"), JINGLE);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"swordproj"), SWORDPROJ);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"powerswordproj"), POWERSWORDPROJ);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"piercespore"), PIERCESPORE);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"piercespore_shadow"), PIERCESPORESHADOW);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"bark"), BARK);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"brain"), BRAIN);
        Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"sun"), SUN);
        Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"smallsun"), SMALLSUN);
        Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"largesun"), LARGESUN);
        Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"grass_tile"), GRASS_TILE);
        Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"dark_grass_tile"), DARK_GRASS_TILE);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"roof_tile"), ROOF_TILE);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"dark_roof_tile"), DARK_ROOF_TILE);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"upgrade_tile"), UPGRADE_TILE);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"premium_tile"), PREMIUM_TILE);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"egypt_tile"), EGYPT_TILE);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"dark_egypt_tile"), DARK_EGYPT_TILE);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"pirate_tile"), PIRATE_TILE);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"dark_pirate_tile"), DARK_PIRATE_TILE);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"west_tile"), WEST_TILE);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"dark_west_tile"), DARK_WEST_TILE);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"future_tile"), FUTURE_TILE);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"dark_future_tile"), DARK_FUTURE_TILE);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"night_tile"), NIGHT_TILE);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"dark_night_tile"), DARK_NIGHT_TILE);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"darkages_tile"), DARKAGES_TILE);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"dark_darkages_tile"), DARK_DARKAGES_TILE);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"sand_tile"), SAND_TILE);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"dark_sand_tile"), DARK_SAND_TILE);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"underwater_tile"), UNDERWATER_TILE);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"dark_underwater_tile"), DARK_UNDERWATER_TILE);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"frost_tile"), FROST_TILE);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"dark_frost_tile"), DARK_FROST_TILE);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"lostcity_tile"), LOSTCITY_TILE);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"dark_lostcity_tile"), DARK_LOSTCITY_TILE);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"skycity_tile"), SKYCITY_TILE);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"dark_skycity_tile"), DARK_SKYCITY_TILE);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"fairy_tile"), FAIRY_TILE);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"dark_fairy_tile"), DARK_FAIRY_TILE);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"mausoleum_tile"), MAUSOLEUM_TILE);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"dark_mausoleum_tile"), DARK_MAUSOLEUM_TILE);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"legendary_tile"), LEGENDARY_TILE);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"gardeningglove"), GARDENINGGLOVE);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"fertilizer"), FERTILIZER);
        Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"sunflower_seed_packet"), SUNFLOWER_SEED_PACKET);
        Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"peashooter_seed_packet"), PEASHOOTER_SEED_PACKET);
        Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"cherrybomb_seed_packet"), CHERRYBOMB_SEED_PACKET);
        Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"wallnut_seed_packet"), WALLNUT_SEED_PACKET);
        Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"potatomine_seed_packet"), POTATOMINE_SEED_PACKET);
        Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"snowpea_seed_packet"), SNOW_PEA_SEED_PACKET);
        Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"chomper_seed_packet"), CHOMPER_SEED_PACKET);
        Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"repeater_seed_packet"), REPEATER_SEED_PACKET);
        Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"sunshroom_seed_packet"), SUNSHROOM_SEED_PACKET);
        Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"puffshroom_seed_packet"), PUFFSHROOM_SEED_PACKET);
        Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"fumeshroom_seed_packet"), FUMESHROOM_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"oxygae_seed_packet"), OXYGAE_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"breezeshroom_seed_packet"), BREEZESHROOM_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"burstshroom_seed_packet"), BURSTSHROOM_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"superchomper_seed_packet"), SUPERCHOMPER_SEED_PACKET);
        Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"gravebuster_seed_packet"), GRAVEBUSTER_SEED_PACKET);
        Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"hypnoshroom_seed_packet"), HYPNOSHROOM_SEED_PACKET);
        Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"scaredyshroom_seed_packet"), SCAREDYSHROOM_SEED_PACKET);
        Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"iceshroom_seed_packet"), ICESHROOM_SEED_PACKET);
        Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"doomshroom_seed_packet"), DOOMSHROOM_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"lilypad_seed_packet"), LILYPAD_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"squash_seed_packet"), SQUASH_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"tanglekelp_seed_packet"), TANGLEKELP_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"threepeater_seed_packet"), THREEPEATER_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"jalapeno_seed_packet"), JALAPENO_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"spikeweed_seed_packet"), SPIKEWEED_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"torchwood_seed_packet"), TORCHWOOD_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"tallnut_seed_packet"), TALLNUT_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"seashroom_seed_packet"), SEASHROOM_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"magnetshroom_seed_packet"), MAGNETSHROOM_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"cabbagepult_seed_packet"), CABBAGEPULT_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"kernalpult_seed_packet"), KERNALPULT_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"melonpult_seed_packet"), MELONPULT_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"melonslice_seed_packet"), MELONSLICE_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"wintermelon_seed_packet"), WINTERMELON_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"coffeebean_seed_packet"), COFFEEBEAN_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"gatlingpea_seed_packet"), GATLINGPEA_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"retrogatling_seed_packet"), RETROGATLING_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"gloomshroom_seed_packet"), GLOOMSHROOM_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"cattail_seed_packet"), CATTAIL_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"twinsunflower_seed_packet"), TWINSUNFLOWER_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"spikerock_seed_packet"), SPIKEROCK_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"bloomerang_seed_packet"), BLOOMERANG_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"icebergpult_seed_packet"), ICEBERGPULT_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"beet_seed_packet"), BEET_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"shamrock_seed_packet"), SHAMROCK_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"chillypepper_seed_packet"), CHILLYPEPPER_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"beeshooter_seed_packet"), BEESHOOTER_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"snowqueenpea_seed_packet"), SNOW_QUEENPEA_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"chester_seed_packet"), CHESTER_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"vampireflower_seed_packet"), VAMPIREFLOWER_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"acidshroom_seed_packet"), ACIDSHROOM_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"dandelionweed_seed_packet"), DANDELIONWEED_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"perfoomshroom_seed_packet"), PERFOOMSHROOM_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"iceberglettuce_seed_packet"), ICEBERGLETTUCE_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"springbean_seed_packet"), SPRINGBEAN_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"coconutcannon_seed_packet"), COCONUTCANNON_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"lightningreed_seed_packet"), LIGHTNINGREED_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"peapod_seed_packet"), PEAPOD_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"empeach_seed_packet"), EMPEACH_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"pepperpult_seed_packet"), PEPPERPULT_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"firepea_seed_packet"), FIRE_PEA_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"endurian_seed_packet"), ENDURIAN_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"goldleaf_seed_packet"), GOLDLEAF_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"shadowshroom_seed_packet"), SHADOWSHROOM_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"missiletoe_seed_packet"), MISSILETOE_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"electropea_seed_packet"), ELECTROPEA_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"peanut_seed_packet"), PEANUT_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"ghostpepper_seed_packet"), GHOSTPEPPER_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"olivepit_seed_packet"), OLIVEPIT_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"gloomvine_seed_packet"), GLOOMVINE_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"heavenlypeach_seed_packet"), HEAVENLYPEACH_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"magicshroom_seed_packet"), MAGICSHROOM_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"saucer_seed_packet"), SAUCER_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"springprincess_seed_packet"), SPRINGPRINCESS_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"dripphylleia_seed_packet"), DRIPPHYLLEIA_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"pumpkinwitch_seed_packet"), PUMPKINWITCH_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"tulimpeter_seed_packet"), TULIMPETER_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"narcissus_seed_packet"), NARCISSUS_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"impatyens_seed_packet"), IMPATYENS_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"hammerflower_seed_packet"), HAMMERFLOWER_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"meteorhammer_seed_packet"), METEORHAMMER_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"frisbloom_seed_packet"), FRISBLOOM_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"beautyshroom_seed_packet"), BEAUTYSHROOM_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"charmshroom_seed_packet"), CHARMSHROOM_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"magnetoshroom_seed_packet"), MAGNETOSHROOM_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"smackadamia_seed_packet"), SMACKADAMIA_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"bombseedling_seed_packet"), BOMBSEEDLING_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"oilyolive_seed_packet"), OILYOLIVE_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"zapricot_seed_packet"), ZAPRICOT_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"bananasaurus_seed_packet"), BANANASAURUS_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"smooshroom_seed_packet"), SMOOSHROOM_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"navybean_seed_packet"), NAVYBEAN_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"admiralnavybean_seed_packet"), ADMIRALNAVYBEAN_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"jumpingbean_seed_packet"), JUMPINGBEAN_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"sunflowerseed_seed_packet"), SUNFLOWERSEED_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"bellflower_seed_packet"), BELLFLOWER_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"knightpea_seed_packet"), KNIGHTPEA_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"nightcap_seed_packet"), NIGHTCAP_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"doomrose_seed_packet"), DOOMROSE_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"dogwood_seed_packet"), DOGWOOD_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"gambleshroom_seed_packet"), GAMBLESHROOM_SEED_PACKET);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"missiletoetarget"), MISSILETOE_TARGET);
        Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"browncoat_egg"), BROWNCOATEGG);
        Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"flagzombie_egg"), FLAGZOMBIEEGG);
        Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"conehead_egg"), CONEHEADEGG);
        Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"polevaulting_egg"), POLEVAULTINGEGG);
        Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"buckethead_egg"), BUCKETHEADEGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"summerbasic_egg"), SUMMERBASICEGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"flagsummer_egg"), FLAGSUMMEREGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"summercone_egg"), SUMMERCONEEGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"summerbucket_egg"), SUMMERBUCKETEGG);
        Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"screendoor_egg"), SCREENDOOREGG);
        Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"newspaper_egg"), NEWSPAPEREGG);
        Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"football_egg"), FOOTBALLEGG);
        Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"dancingzombie_egg"), DANCINGZOMBIEEGG);
        Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"backupdancer_egg"), BACKUPDANCEREGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"snorkel_egg"), SNORKELEGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"dolphinrider_egg"), DOLPHINRIDEREGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"zomboni_egg"), ZOMBONIEGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"bobsled_egg"), BOBSLEDEGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"gargantuar_egg"), GARGANTUAREGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"mummygargantuar_egg"), MUMMYGARGANTUAREGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"unicorngargantuar_egg"), UNICORNGARGANTUAREGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"imp_egg"), IMPEGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"mummyimp_egg"), MUMMYIMPEGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"rainbowbassimp_egg"), BASSIMPEGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"scrapmech_egg"), SCRAPMECHEGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"scrapimp_egg"), SCRAPIMPEGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"trashcan_egg"), TRASHCANEGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"berserker_egg"), BERSERKEREGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"mummy_egg"), MUMMYEGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"flagmummy_egg"), FLAGMUMMYEGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"mummycone_egg"), MUMMYCONEEGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"mummybucket_egg"), MUMMYBUCKETEGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"explorer_egg"), EXPLOREREGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"tombraiser_egg"), TOMBRAISEREGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"torchlight_egg"), TORCHLIGHTEGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"pyramidhead_egg"), PYRAMIDHEADEGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"undying_egg"), UNDYINGEGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"pharaoh_egg"), PHARAOHEGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"peasant_egg"), PEASANTEGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"flagpeasant_egg"), FLAGPEASANTEGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"peasantcone_egg"), PEASANTCONEEGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"peasantbucket_egg"), PEASANTBUCKETEGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"peasantknight_egg"), PEASANTKNIGHTEGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"futurezombie_egg"), FUTUREZOMBIEEGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"flagfuture_egg"), FLAGFUTUREEGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"futurecone_egg"), FUTURECONEEGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"futurebucket_egg"), FUTUREBUCKETEGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"holohead_egg"), HOLOHEADEGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"announcerimp_egg"), ANNOUNCERIMPEGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"redannouncerimp_egg"), REDANNOUNCERIMPEGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"blackannouncerimp_egg"), BLACKANNOUNCERIMPEGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"zombieking_egg"), ZOMBIEKINGEGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"redzombieking_egg"), REDZOMBIEKINGEGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"blackzombieking_egg"), BLACKZOMBIEKINGEGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"impdragon_egg"), IMPDRAGONEGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"jetpack_egg"), JETPACKEGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"robocone_egg"), ROBOCONEEGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"blastronaut_egg"), BLASTRONAUTEGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"octo_egg"), OCTOEGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"brickhead_egg"), BRICKHEADEGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"sundayedition_egg"), SUNDAYEDITIONEGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"superfanimp_egg"), SUPERFANIMPEGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"bass_egg"), BASSEGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"pumpkinzombie_egg"), PUMPKINZOMBIEEGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"newyearimp_egg"), NEWYEARIMPEGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"pokerzombie_egg"), POKEREGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"flagpoker_egg"), FLAGPOKEREGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"pokerconehead_egg"), POKERCONEEGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"pokerbuckethead_egg"), POKERBUCKETEGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"pokerpawn_egg"), POKERPAWNEGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"pokerknight_egg"), POKERKNIGHTEGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"pokertower_egg"), POKERTOWEREGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"pokerbishop_egg"), POKERBISHOPEGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"sargeant_egg"), SARGEANTEGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"flagsargeant_egg"), FLAGSARGEANTEGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"sargeantcone_egg"), SARGEANTCONEEGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"sargeantbucket_egg"), SARGEANTBUCKETEGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"sargeantshield_egg"), SARGEANTSHIELDEGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"bookburner_egg"), BOOKBURNEREGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"zombiepiggy_egg"), PIGGYEGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"hawkercart_egg"), HAWKEREGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"soldier_egg"), SOLDIEREGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"scientist_egg"), SCIENTISTEGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"hovergoat_egg"), HOVERGOATEGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"zomblob_egg"), ZOMBLOBEGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"defensiveend_egg"), DEFENSIVEENDEGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"cursedgargolith_egg"), CURSEDGARGOLITHEGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"impthrow_egg"), IMPTHROWEGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"80sactionhero_egg"), ACTIONHEROEGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"bully_egg"), BULLYEGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"basketballcarrier_egg"), BASKETBALLCARRIEREGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"crystalshoeimp_egg"), CRYSTALSHOEIMPEGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"pumpkincarriage_egg"), PUMPKINCARRIAGEEGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"locustswarm_egg"), LOCUSTSWARMEGG);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"easy"), EASY);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"easymed"), EASYMED);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"med"), MED);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"medhard"), MEDHARD);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"hard"), HARD);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"superhard"), SUPERHARD);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"nightmare"), NIGHTMARE);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"crazy"), CRAAAAZY);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"onebyone"), ONEBYONE);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"half"), HALF);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"infinite"), INFINITE);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"unlock"), UNLOCK);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"unlockspecial"), UNLOCKSPECIAL);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"day"), DAY);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"night"), NIGHT);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"bomb"), BOMB);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"drought"), DROUGHT);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"clear"), CLEAR);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"rain"), RAIN);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"thunder"), THUNDER);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"zombiegrave_spawn"), ZOMBIEGRAVESPAWN);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"basicgrave_spawn"), BASICGRAVESPAWN);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"basictomb_spawn"), BASICTOMBSPAWN);
        Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"nightgrave_spawn"), NIGHTGRAVESPAWN);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"poolgrave_spawn"), POOLGRAVESPAWN);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"roofgrave_spawn"), ROOFGRAVESPAWN);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"egyptgrave_spawn"), EGYPTGRAVESPAWN);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"futuregrave_spawn"), FUTUREGRAVESPAWN);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"darkagesgrave_spawn"), DARKAGESGRAVESPAWN);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"fairytalegrave_spawn"), FAIRYTALEGRAVESPAWN);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"mausoleumgrave_spawn"), MAUSOLEUMGRAVESPAWN);
        Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"daves_shovel"), DAVES_SHOVEL);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"garden_spawn"), GARDEN_SPAWN);
		Registry.register(Registries.ITEM, Identifier.of(PvZCubed.MOD_ID,"gardenchallenge_spawn"), GARDENCHALLENGE_SPAWN);
    }
}
