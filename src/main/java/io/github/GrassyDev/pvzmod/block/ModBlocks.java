...
public class ModBlocks {
	...
	public static void registerBlocks(){
		Registry.register(Registries.BLOCK, Identifier.of(PvZCubed.MOD_ID,"pea_crop"), PEA_CROP);
		Registry.register(Registries.BLOCK, Identifier.of(PvZCubed.MOD_ID,"botany_station"), BOTANY_STATION);
        Registry.register(Registries.BLOCK, Identifier.of(PvZCubed.MOD_ID,"grass_tile"), GRASS_TILE);
        Registry.register(Registries.BLOCK, Identifier.of(PvZCubed.MOD_ID,"dark_grass_tile"), DARK_GRASS_TILE);
		Registry.register(Registries.BLOCK, Identifier.of(PvZCubed.MOD_ID,"night_tile"), NIGHT_TILE);
		Registry.register(Registries.BLOCK, Identifier.of(PvZCubed.MOD_ID,"dark_night_tile"), DARK_NIGHT_TILE);
		Registry.register(Registries.BLOCK, Identifier.of(PvZCubed.MOD_ID,"roof_tile"), ROOF_TILE);
		Registry.register(Registries.BLOCK, Identifier.of(PvZCubed.MOD_ID,"dark_roof_tile"), DARK_ROOF_TILE);
		Registry.register(Registries.BLOCK, Identifier.of(PvZCubed.MOD_ID,"upgrade_tile"), UPGRADE_TILE);
		Registry.register(Registries.BLOCK, Identifier.of(PvZCubed.MOD_ID,"premium_tile"), PREMIUM_TILE);
		Registry.register(Registries.BLOCK, Identifier.of(PvZCubed.MOD_ID,"egypt_tile"), EGYPT_TILE);
		Registry.register(Registries.BLOCK, Identifier.of(PvZCubed.MOD_ID,"dark_egypt_tile"), DARK_EGYPT_TILE);
		Registry.register(Registries.BLOCK, Identifier.of(PvZCubed.MOD_ID,"pirate_tile"), PIRATE_TILE);
		Registry.register(Registries.BLOCK, Identifier.of(PvZCubed.MOD_ID,"dark_pirate_tile"), DARK_PIRATE_TILE);
		Registry.register(Registries.BLOCK, Identifier.of(PvZCubed.MOD_ID,"west_tile"), WEST_TILE);
		Registry.register(Registries.BLOCK, Identifier.of(PvZCubed.MOD_ID,"dark_west_tile"), DARK_WEST_TILE);
		Registry.register(Registries.BLOCK, Identifier.of(PvZCubed.MOD_ID,"future_tile"), FUTURE_TILE);
		Registry.register(Registries.BLOCK, Identifier.of(PvZCubed.MOD_ID,"dark_future_tile"), DARK_FUTURE_TILE);
		Registry.register(Registries.BLOCK, Identifier.of(PvZCubed.MOD_ID,"darkages_tile"), DARKAGES_TILE);
		Registry.register(Registries.BLOCK, Identifier.of(PvZCubed.MOD_ID,"dark_darkages_tile"), DARK_DARKAGES_TILE);
		Registry.register(Registries.BLOCK, Identifier.of(PvZCubed.MOD_ID,"sand_tile"), SAND_TILE);
		Registry.register(Registries.BLOCK, Identifier.of(PvZCubed.MOD_ID,"dark_sand_tile"), DARK_SAND_TILE);
		Registry.register(Registries.BLOCK, Identifier.of(PvZCubed.MOD_ID,"underwater_tile"), UNDERWATER_TILE);
		Registry.register(Registries.BLOCK, Identifier.of(PvZCubed.MOD_ID,"dark_underwater_tile"), DARK_UNDERWATER_TILE);
		Registry.register(Registries.BLOCK, Identifier.of(PvZCubed.MOD_ID,"frost_tile"), FROST_TILE);
		Registry.register(Registries.BLOCK, Identifier.of(PvZCubed.MOD_ID,"dark_frost_tile"), DARK_FROST_TILE);
		Registry.register(Registries.BLOCK, Identifier.of(PvZCubed.MOD_ID,"lostcity_tile"), LOSTCITY_TILE);
		Registry.register(Registries.BLOCK, Identifier.of(PvZCubed.MOD_ID,"dark_lostcity_tile"), DARK_LOSTCITY_TILE);
		Registry.register(Registries.BLOCK, Identifier.of(PvZCubed.MOD_ID,"skycity_tile"), SKYCITY_TILE);
		Registry.register(Registries.BLOCK, Identifier.of(PvZCubed.MOD_ID,"dark_skycity_tile"), DARK_SKYCITY_TILE);
		Registry.register(Registries.BLOCK, Identifier.of(PvZCubed.MOD_ID,"fairy_tile"), FAIRY_TILE);
		Registry.register(Registries.BLOCK, Identifier.of(PvZCubed.MOD_ID,"dark_fairy_tile"), DARK_FAIRY_TILE);
		Registry.register(Registries.BLOCK, Identifier.of(PvZCubed.MOD_ID,"mausoleum_tile"), MAUSOLEUM_TILE);
		Registry.register(Registries.BLOCK, Identifier.of(PvZCubed.MOD_ID,"dark_mausoleum_tile"), DARK_MAUSOLEUM_TILE);
		Registry.register(Registries.BLOCK, Identifier.of(PvZCubed.MOD_ID,"legendary_tile"), LEGENDARY_TILE);
